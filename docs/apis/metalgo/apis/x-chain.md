...
The [X-Chain](../../../overview/getting-started/intro.md#exchange-chain-x-chain), Metal's native platform for creating and trading assets, is an instance of the Avalanche Virtual Machine (AVM). This API allows clients to create and trade assets on the X-Chain and other instances of the AVM.
            ...
            "asset1": {
                ...
                "initialState": {
                    "fixedCap" : [
                        {
                            "amount":100000,
                            "address": "metal13ery2kvdrkd2nkquvs892gl8hg7mq4a6ufnrn6"
                        },
                        {
                            "amount":100000,
                            "address": "metal1rvks3vpe4cm9yc0rrk8d5855nd6yxxutfc2h2r"
                        },
                        {
                            "amount":50000,
                            "address": "metal1ntj922dj4crc4pre4e0xt3dyj0t5rsw9uw0tus"
                        },
                        {
                            "amount":50000,
                            "address": "metal1yk0xzmqyyaxn26sqceuky2tc2fh2q327vcwvda"
                        }
                    ]
                }
            },
            "asset2": {
                ...
                "initialState": {
                    "variableCap" : [
                        {
                            "minters": [
                                "metal1kcfg6avc94ct3qh2mtdg47thsk8nrflnrgwjqr",
                                "metal14e2s22wxvf3c7309txxpqs0qe9tjwwtk0dme8e"
                            ],
                            "threshold":1
                        },
                        {
                            "minters": [
                                "metal1y8pveyn82gjyqr7kqzp72pqym6xlch9gt5grck",
                                "metal1c5cmm0gem70rd8dcnpel63apzfnfxye9kd4wwe",
                                "metal12euam2lwtwa8apvfdl700ckhg86euag2hlhmyw"
                            ],
                            "threshold":2
                        }
                    ]
...
```json
{
  "jsonrpc": "2.0",
  "result": {
    "address": "X-metal18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5"
  },
  "id": 1
}
```
...
curl -X POST --data '{
    ...
    "params" :{
        ...
        "minterSets":[
            {
                "minters":[
                    "X-metal18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5"
                ],
                "threshold": 1
            },
            {
...
curl -X POST --data '{
    ...
    "params" :{
        ...
        "minterSets":[
            {
                "minters":[
                    "X-metal1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8"
                ],
                "threshold": 1
            }
        ],
        "from": ["X-metal1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8"],
        "changeAddr": "X-metal1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8",
        "username":"myUsername",
        "password":"myPassword"
    }
...
curl -X POST --data '{
    ...
    "params" :{
        "address":"X-metal1c79e0dd0susp7dc8udq34jgk2yvve7hapvdyht"
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/bc/X
```
...
curl -X POST --data '{
    ...
    "params" :{
        "assetID" :"YE6TDrJaTWF79KfqtL5KLiYgyTYnTp7jZzHEwWhQ4sDvLmraX"
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/bc/X
```
        ...
        "outputs": [
          {
            ...
            "output": {
              "addresses": ["X-metal126rd3w35xwkmj8670zvf7y5r8k36qa9z9803wm"],
              "amount": 1530084210,
              "locktime": 0,
              "threshold": 1
            }
...
- `networkID` is the ID of the network this transaction happened on. (Metal Mainnet is `1`.)
- `blockchainID` is the ID of the blockchain this transaction happened on. (Metal Mainnet X-Chain is `35N6YCBV33rHJWAtMELT4EZkFfzU7eusLUnhWcDXjHoxh1AiN`.)
...
- `assetID`: The ID of the asset being transferred. (The Mainnet Metal ID is `YE6TDrJaTWF79KfqtL5KLiYgyTYnTp7jZzHEwWhQ4sDvLmraX`.)
...
Suppose we want all UTXOs that reference at least one of `X-metal18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5` and `X-metal1d09qn852zcy03sfc9hay2llmn9hsgnw4tp3dv6`.
...
curl -X POST --data '{
    ...
    "method" :"avm.getUTXOs",
    "params" :{
        "addresses":["X-metal18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5", "X-metal1d09qn852zcy03sfc9hay2llmn9hsgnw4tp3dv6"],
        "limit":5,
        "encoding": "hex"
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/bc/X
...
curl -X POST --data '{
    ...
    "method" :"avm.getUTXOs",
    "params" :{
        "addresses":["X-metal18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5"],
        "limit":5,
        "startIndex": {
            "address": "X-metal18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5",
            "utxo": "kbUThAUfmBXUmRgTpgD6r3nLj7rJUGho6xyht5nouNNypH45j"
...
- `to` is the address the METAL is sent to. This must be the same as the `to` argument in the corresponding call to the P-Chain’s `exportAVAX` or C-Chain's `export`.
- `sourceChain` is the ID or alias of the chain the METAL is being imported from. To import funds from the C-Chain, use `"C"`.
    ...
    "params" :{
        "outputs": [
            ...
            },
            {
                ...
                "to"      : "X-metal18knvhxx8uhc0mwlgrfyzjcm2wrd6e60w37xrjq",
                "amount"  : 10
            }
        ],
        "memo"      : "hi, mom!",
...
func main() {
    ...
    addresses = append(addresses, " X-tahoe....")
...
| **AddAddresses** | add an address to the set    | {"addAddresses":{"addresses":\["X-tahoe..."\]}}              | addresses - list of addresses to match                                                                                             |
