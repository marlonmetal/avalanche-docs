...
- `endTime` is the Unix time when the delegator stops delegating (and staked METAL is returned).
- `stakeAmount` is the amount of nMETAL the delegator is staking.
...
- `endTime` is the Unix time when the validator stops validating the Primary Network (and staked METAL is returned).
- `stakeAmount` is the amount of nMETAL the validator is staking.
...
- `balance` is the total balance, in nMETAL.
- `unlocked` is the unlocked balance, in nMETAL.
- `lockedStakeable` is the locked stakeable balance, in nMETAL.
- `lockedNotStakeable` is the locked and not stakeable balance, in nMETAL.
